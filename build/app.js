...
const frontendPath = _path.default.join(__dirname, "../frontendBuild");
app.use(_express.default.static(frontendPath));
...
app.get("/doc", _swaggerUiExpress.default.setup(_swagger.default, options));
