...
class EstimationController {
  ...
  // approve estimation
  static async approveEstimation(req, res) {
    try {
      ...
      if (estimation.isApproved) {
        ...
        return (0, _response.onSuccess)(res, 200, 'estimation unapproved successfully', estimation);
      }
      await estimation.update({
        isApproved: true
      });
      return (0, _response.onSuccess)(res, 200, 'estimation approved successfully', estimation);
    } catch (error) {
  ...
  static async updateEstimation(req, res) {
    try {
      ...
      for (let i = 0; i < equipments.length; i++) {
        ...
        const equipmentTotalAmount = equipmentPerformance * +equipment.hireRatePrice;
      ...
      const updatedestimation = await _models.Estimations.findOne({
        where: {
          id: req.params.id
        },
        include: [{
          ...
          model: _models.SubContractors,
          as: "subContractors",
          attributes: ["id", "name", "unit", "quantity", "price", "caveragePerUnit"],
          through: {
            attributes: ["subContractorTotalAmount"]
          }
        }]
      });
      return (0, _response.onSuccess)(res, 200, "Estimation updated successfully", updatedestimation);
    } catch (error) {
  ...
  static async removeEquipmentFromEstimation(req, res) {
    try {
      ...
      return (0, _response.onSuccess)(res, 200, "Equipment Removed successfully", updateEstimation);
    } catch (error) {
      console.log("error: ", error);
      return (0, _response.onError)(res, 500, "Internal Server Error", error.message);
    }
  ...
  static async editEstimationEquipment(req, res) {
    try {
      ...
      // calculate Overhead, Contigency and Profit
      const calculatedOverHead = subtotal * +updateEstimation?.overHeadPercentage;
      const calculatedContigency = subtotal * +updateEstimation?.contigencyPercentage;
      ...
      return (0, _response.onSuccess)(res, 200, "Equipment Updated successfully", updateEstimation);
    } catch (error) {
      return (0, _response.onError)(res, 500, "Internal Server Error");
    }
  }
  ...
  static async removeMaterialFromEstimation(req, res) {
    try {
      ...
      return (0, _response.onSuccess)(res, 200, "Material Removed successfully", updateEstimation);
    } catch (error) {
      console.log("error: ", error);
      return (0, _response.onError)(res, 500, "Internal Server Error", error.message);
    }
  ...
  static async editEstimationMaterials(req, res) {
    try {
      ...
      return (0, _response.onSuccess)(res, 200, "Material Updated successfully", updateEstimation);
    } catch (error) {
      return (0, _response.onError)(res, 500, "Internal Server Error");
    }
  }
  ...
  static async removeLabourFromEstimation(req, res) {
    try {
      ...
      return (0, _response.onSuccess)(res, 200, "Labour Removed successfully", updateEstimation);
    } catch (error) {
      console.log("error: ", error);
      return (0, _response.onError)(res, 500, "Internal Server Error", error.message);
    }
  ...
  static async editLabourEstimation(req, res) {
    try {
      ...
      return (0, _response.onSuccess)(res, 200, "Labour Updated successfully", updateEstimation);
    } catch (error) {
      return (0, _response.onError)(res, 500, "Internal Server Error");
    }
  }
  ...
  static async addSubcontractorToEstimation(req, res) {
    try {
      ...
      const subContractorTotalAmount = subcontractor.quantity * +subcontractor.price;
  ...
  static async removeSubcontractorFromEstimation(req, res) {
    try {
      ...
      return (0, _response.onSuccess)(res, 200, "Subcontractor Removed successfully", updateEstimation);
    } catch (error) {
      console.log("error: ", error);
      return (0, _response.onError)(res, 500, "Internal Server Error", error.message);
    }
  ...
  static async editSubcontractorEstimation(req, res) {
    try {
      ...
      return (0, _response.onSuccess)(res, 200, "subcontractor Updated successfully", updateEstimation);
    } catch (error) {
      return (0, _response.onError)(res, 500, "Internal Server Error");
    }
  }
}
var _default = exports.default = EstimationController;